...
const markRuss =
 Number(prompt(`Введите кол-во баллов по русскому языку:`, `75`));
...
if (ATM >= 100) {
  ...
  alert(`Банкомат, не сможет выдать вам ${ATM}
   рублей, так как минимальная купюра в банкомате 100 рублей`);
} if (ATM !== Number(ATM)) {
